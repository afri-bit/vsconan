...
export class ConanRemoteItem extends vscode.TreeItem {
    ...
    public setRemoteEnableIcon(state: boolean) {
        if (state) { // Remote is enabled
            this.iconPath = {
                light: vscode.Uri.file(path.join(__filename, '..', '..', '..', '..', '..', '..', 'resources', 'icon', 'light', 'remote_on.png')),
                dark: vscode.Uri.file(path.join(__filename, '..', '..', '..', '..', '..', '..', 'resources', 'icon', 'dark', 'remote_on.png'))
            };
        }
        else { // Remote is disabled
            this.iconPath = {
                light: vscode.Uri.file(path.join(__filename, '..', '..', '..', '..', '..', '..', 'resources', 'icon', 'light', 'remote_off.png')),
                dark: vscode.Uri.file(path.join(__filename, '..', '..', '..', '..', '..', '..', 'resources', 'icon', 'dark', 'remote_off.png'))
            };
        }
    }
